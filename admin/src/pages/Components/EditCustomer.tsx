...
const EditCustomer: React.FC = () => {
    ...
    const validate = (): boolean => {
        ...
        } else if ((customer.email || customer.EMAILID) && !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(customer.email || customer.EMAILID)) {
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className={`form-control w-full border ${errors.MOBILE ? 'border-red-500' : 'border-gray-300'} rounded px-3 py-2`}
                                required
                            />
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className={`form-control w-full border ${errors.CPINCODE ? 'border-red-500' : 'border-gray-300'} rounded px-3 py-2`}
                                required
                            />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className={`form-control w-full border ${errors.email ? 'border-red-500' : 'border-gray-300'} rounded px-3 py-2`}
                                required
                            />
