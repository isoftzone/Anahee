...
const SizeChartModal = ({ chartType }) => {
  return (
    <div className="size-chart-container p-3">
      {chartType === "western" && (
        <div className="size-chart-section mb-4">
          <h5 className="section-title mb-3 fw-bold text-primary">
            Western Wear
          </h5>
...
const ProductDescriptionInfo = ({
  ...
  const handleSizeChartClick = () => {
    // Determine which chart to show based on product type
    const isKurta =
      product.category === "kurta" ||
      product.name.toLowerCase().includes("kurta") ||
      product.type === "traditional";
    setChartType(isKurta ? "kurta" : "western");
    setShow(true);
  };
          ...
          <div className="pro-details-size">
            <div className="pro-details-size">
              ...
              >
                ...
                <Modal.Body>
                  <SizeChartModal chartType={chartType} />
                </Modal.Body>
              </Modal>
            </div>
