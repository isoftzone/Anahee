...
//   </li>
//   <li>
//     <Link style={{ fontSize: "15px" }} to="/about">
//       About us
//     </Link>
//   </li>
//   <li>
...
//           {/* USEFUL LINKS */}
//           <div className="col-12 col-sm-6 col-md-6 col-lg-3">
//             <div className="footer-widget pt-3 mt-5 text-center text-md-center">
//               {/* <div className="footer-title">
//                 <h3>USEFUL LINKS</h3>
//               </div> */}
...
//   <li>
//     <Link style={{ fontSize: "15px" }} to="/cancellation-policy">
//       Cancellation Policy
//     </Link>
//   </li>
//   <li>
...
//   </li>
//   <li>
//     <Link style={{ fontSize: "15px" }} to="/exchange-policy">
//       Exchange Policy
//     </Link>
//   </li>
// </ul>
...
//           &copy; {new Date().getFullYear()} Anahee (Anand Fashion) All Rights
//           Reserved
//         </div>
//       </section>
//     </footer>
    ...
    >
      <div className={`${containerClass || "container-fluid mb-5"}`}>
        <div className="row justify-content-center gy-4">
          ...
          {/* Site Map Column */}
          <div className="col-12 col-sm-6 col-md-6 col-lg-3">
            <div className="footer-widget text-center text-md-center pt-4">
              <h4 className="text-dark mb-3 fw-bold">SITE MAP</h4>
          ...
          <div className="col-12 col-sm-6 col-md-6 col-lg-3">
            <div className="footer-widget text-center text-md-center pt-4">
              <h4 className="text-dark mb-3 fw-bold d-none d-md-block invisible">
                Hidden
              </h4>
              <ul className="list-unstyled d-flex flex-column align-items-center align-items-md-center">
                 <li>
